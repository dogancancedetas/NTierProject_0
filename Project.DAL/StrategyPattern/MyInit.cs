...
namespace Project.DAL.StrategyPattern
{
    ...
    public class MyInit: CreateDatabaseIfNotExists<MyContext>
    {
        protected override void Seed(MyContext context)
        {
            ...
            au.Email = "dogancancedetas@gmail.com";
            ...
            for (int i = 2; i < 12; i++)
            {
                ...
                up.ID = i; //Birebir ilişki olduğundan dolayı üst tarafa oluşturulan AppUser'ların ID'leri ile buralar eşleşmeli. O yüzden döngünün iterasyonunu 2'den başlattık.

...
namespace Project.MVCUI.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Login(AppUser appUser)
        {
            ...
            string decyrped = DantexCrypt.DeCrypt(yakalanan.Password);
            if (appUser.Password == decyrped && yakalanan.Role == ENTITIES.Enums.UserRole.Admin)
            {
            ...
            else if (yakalanan.Role == ENTITIES.Enums.UserRole.Member && appUser.Password == decyrped)
            {
                if (!yakalanan.Active) return AktifKontrol();
